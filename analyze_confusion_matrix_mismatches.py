#!/usr/bin/env python3
"""
Confusion Matrix Mismatch Analysis
=================================

This script analyzes cases where the model predictions disagree with the labels:
1. Model predicts MCI but label is 0 (False Positives)
2. Model predicts 0 but label is MCI (False Negatives)
...
This will help understand why the model and labels disagree.
"""
...
def main():
    """Main function"""
    print("="*60)
    print("Confusion Matrix Mismatch Analysis")
    print("="*60)
    ...
    print("13. Getting QID descriptions...")
    qid_descriptions = get_qid_descriptions(data_dict, COGNITIVE_QIDS)
    
    # Create detailed analysis
    print("14. Creating detailed mismatch analysis...")
    ...
    print("15. Adding QID descriptions...")
    ...
    # Save main results
    output_file = OUTPUT_DIR / 'confusion_matrix_mismatch_analysis.csv'
    ...
    with open(OUTPUT_DIR / 'confusion_matrix_mismatch_summary.json', 'w') as f:
        json.dump(summary, f, indent=2)
    
    print(f"   Summary saved to: {OUTPUT_DIR / 'confusion_matrix_mismatch_summary.json'}")
