#!/usr/bin/env python3
"""
BHR MemTrax Exact Minimal - Reproduces AUC=0.798
================================================
Exact copy of working script with minimal output.
"""
print("🎯 REPRODUCING AUC=0.798...")
#!/usr/bin/env python3
"""
...
# Extract final AUC from the output
import re
with open('bhr_memtrax_results/clinical_utility_report.json', 'r') as f:
    report = json.load(f)
    final_auc = report['model_metrics']['auc_overall']
