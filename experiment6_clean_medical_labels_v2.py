#!/usr/bin/env python3
"""
Experiment 6: Clean Up Medical Labels (Version 2)
================================================

This experiment tests the impact of cleaning up medical labels by focusing on
the most reliable cognitive impairment indicators:
...
CLEANED QIDs (most reliable):
- QID1-13: Mild Cognitive Impairment (most specific)
- QID1-12: Alzheimer's Disease (well-defined)
- QID1-5: Dementia (general, but reliable)

REMOVED QIDs (less reliable):
- QID1-22: Frontotemporal Dementia (rare, may be misdiagnosed)
- QID1-23: Lewy Body Disease (rare, may be misdiagnosed)
...
# Cleaned cognitive QIDs - focus on most reliable indicators
CLEANED_COGNITIVE_QIDS = ['QID1-5', 'QID1-12', 'QID1-13']  # Remove rare conditions
...
def main():
    ...
    print("="*60)
    print("EXPERIMENT 6: Clean Up Medical Labels (Version 2)")
    print("="*60)
    ...
    print("  CLEANED QIDs: QID1-5 (Dementia), QID1-12 (Alzheimer's), QID1-13 (MCI)")
    print("  REMOVED: QID1-22 (FTD), QID1-23 (LBD) - rare conditions that may be misdiagnosed")
    print("Expected Impact: +0.02-0.05 AUC by reducing false positive labels")
    print()
    ...
    if "Original" in results and "Cleaned" in results:
        ...
        experiment_results = {
            'experiment': 'Clean Up Medical Labels (Version 2)',
            'original_qids': ORIGINAL_COGNITIVE_QIDS,
            'cleaned_qids': CLEANED_COGNITIVE_QIDS,
            'removed_qids': ['QID1-22', 'QID1-23'],
        ...
        with open(OUTPUT_DIR / 'experiment6_clean_medical_labels_v2_results.json', 'w') as f:
            json.dump(experiment_results, f, indent=2)
        
        print(f"\nResults saved to: {OUTPUT_DIR / 'experiment6_clean_medical_labels_v2_results.json'}")
